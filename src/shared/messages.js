export const MSG_TYPES = {
    ...
    // Content Script -> Background（请求在 MAIN world 注入 debug 代理）
    INJECT_DEBUG_GLOBAL: 'INJECT_DEBUG_GLOBAL',
    ...
    GET_RUNNING_PROVIDERS: 'GET_RUNNING_PROVIDERS',
    ...
    LOGIN_REQUIRED: 'LOGIN_REQUIRED', // Content Script 检测到未登录状态
    RETRY_TASK: 'RETRY_TASK' // UI -> Background 请求重试单个通道
};