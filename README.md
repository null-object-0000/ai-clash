...
* 🆓 **拒绝 API 阉割，满血网页体验**
  ...
  **为什么不直接用 API 聚合？** 除了昂贵的 Token 成本，API 往往会丢失官方网页版最核心的“隐藏 BUFF”。本插件采用纯本地 DOM Hook 技术，完美继承各大平台精心调优的**内置系统提示词 (System Prompt)、原生上下文记忆系统以及专属联网/沙盒能力**，让你零成本体验真正的“满血版” AI 集群。
